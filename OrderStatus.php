...
<body>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2 space-x-3 md:space-x-2  rtl:space-x-reverse">
                <p class="text-white self-center text-2xl font-semibold whitespace-nowrap">!!Your Orders!!</p>
            </div>
    ...
    <thead>
        <tr>
            ...
            <th class="py-2 px-4 border-b">Order_Status</th>
    ...
    <tbody>
        ...
        $sql = mysqli_query($conn, "SELECT * FROM Orderr WHERE Customer_Id ='$username'");
